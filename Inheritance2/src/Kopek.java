...
public class Kopek extends Hayvan {
    ...
    public void harekete_gec(int hiz){ //hayvandaki harekete geç'i override ettiğimiz için koşdaki super.harekete_gec demek
        //yerine direk harekete_gec dediğimizde istediğimiz şekilde olmuş oluyor.
    
        System.out.println("Köpek " + hiz + " hız ile hareket ediyor..");
    }
